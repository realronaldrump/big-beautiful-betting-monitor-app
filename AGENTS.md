...
- This repository is edited on Davis's Mac, but no long-lived development or production process should run there.
...
- The mini PC runs the image with `/home/davis/big-beautiful-betting-monitor-app/deploy/compose.yaml`. Docker binds the app only to `127.0.0.1:8720`; Tailscale Serve owns the public path.
